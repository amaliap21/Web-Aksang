...
const IconCardAlt = ({
  ...
  return (
    <div
      className={`w-full sm:w-fit sm:max-w-[430px] lg:min-h-[260px] text-white px-10 pt-[75px] pb-12 lg:pt-[83px] lg:pb-7 font-montserrat items-center rounded-lg bg-gradient-to-tr from-[#0f257f] to-[#3646a3] relative flex flex-col gap-2`}
    >
      <Image
        src={imageUrl}
        alt={imageAlt}
      ...
      <div className="flex flex-col flex-1 justify-between gap-3">
        <div className="flex flex-col items-center justify-start gap-2">
          <h3 className="text-2xl lg:text-4xl text-center font-bold capitalize">
            {title}
          </h3>
