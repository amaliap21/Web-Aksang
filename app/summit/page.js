  ...
  return (
    <main className="bg-[#092079] min-h-screen overflow-hidden overflow-x-hidden relative flex flex-col">
      ...
      <div className="flex items-center justify-center mx-5 rounded-[10px] shadow xl: shadow-white/20 lg:h-[681px] lg:w-[1241px] lg:mx-auto" style={{"background": "linear-gradient(146deg, rgba(255, 255, 255, 0.60) 0%, rgba(255, 255, 255, 0.20) 100%)"}}>
        {/* CONTAINER PUTIH */}
        <div className="flex flex-col lg:flex-row justify-center m-5 gap-20 py-20 px-7 bg-white lg:w-[1137px] lg:h-[615px] rounded-lg  overflow-y-hidden text-center snap-x snap-mandatory">
            ...
            <div className="flex flex-col-reverse items-center justify-center lg:flex-row flex-shrink-0 gap-10 snap-always snap-center">
                {/* TULISAN-KIRI */}
                <div className="flex flex-col lg:w-[599px] lg:h-[296px]">
                ...
                <div className="flex flex-col lg:w-[350px] lg:h-[450px] rounded-xl shadow-[0_4px_4px_0_rgba(0,0,0,0.25)]"  style={{"background": "linear-gradient(317deg, #092079 0%, #4F9BFD 100%)"}}>
                    ...
                    <h2 className=" lg:text-[24px] tracking-[-0.48px] font-[700] montserrat py-5 items-center" >SPEAKER NAME</h2>
                </div>
            </div>
      ...
      {/* ABOUT SPEAKER AWAL/ASLI */}
      <div className="flex items-center justify-center border-radius rounded-[10px] shadow xl: shadow-white/20 h-[681px] w-[1241px] mx-auto" style={{"background": "linear-gradient(146deg, rgba(255, 255, 255, 0.60) 0%, rgba(255, 255, 255, 0.20) 100%)"}}>
        <div className="flex-row gap-20 left-15 bg-white w-[1137px] h-[615px] rounded-lg p-20 flex overflow-y-hidden text-center snap-x snap-mandatory">
            <div className="flex flex-row flex-shrink-0 gap-10 snap-always snap-center">
                ...
                <div className="flex flex-col gap-7 w-[350px] h-[450px] rounded-xl shadow-[0_4px_4px_0_rgba(0,0,0,0.25)]"  style={{"background": "linear-gradient(317deg, #092079 0%, #4F9BFD 100%)"}}>
                    <Image src="/tes-thea.jpg" alt="Speaker" width={250} height={250}/>
