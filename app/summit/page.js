  ...
  return (
    <main className="bg-[#092079] min-h-screen overflow-hidden overflow-x-hidden relative flex flex-col">
      ...
      <Image
        ...
        width={572}
        height={572}
        className="w-[500px] aspect-square absolute z-10 top-0 left-[-80px]"
      ></Image>
      <Image
        src="/summitbg.svg"
        alt="Background summit"
      ...
      <div className="lg:mx-20 mx-10 pt-20 ">
        <h1 className="montserrat font-bold relative text-[54px] text-white tracking-[0.54px] text-5xl text-center">
          ByteTech <span className="text-[#FADE7A]">Summit</span>
        </h1>
        <h2 className="montserrat text-[36px] font-[500] p-2 text-white tracking-[0.72px] text-center">
          Empowering Society’s Future Through Informatics
        </h2>
        <p className="py-10 px-3 tracking-[0.16px] text-[16px] text-white max-w-[1000px] font-[4vw] mx-auto text-center">
      ...
      <div
        className="flex items-center justify-center mx-auto rounded-[10px] max-w-[1200px] shadow xl: shadow-white/20 lg:h-[681px] lg:w-[1100px] md:w-[750px] lg:mx-auto"
        style={{
          background:
      ...
      >
        {/* CONTAINER PUTIH */}
        <div className="flex lg:flex-row m-5 gap-20 py-20 px-7 lg:px-20 bg-white w-[300px] md:w-[1050px] overflow-x-visible snap-both sm:h-[1250px] md:h-[600px] lg:h-[615px] rounded-lg overflow-y-hidden text-center snap-mandatory">
          {/* CONTAINER TULISAN-KARTU */}
          <div className="flex flex-col-reverse sm:flex-row items-center justify-center lg:flex-row flex-shrink-0 gap-10 snap-always snap-center">
            {/* TULISAN-KIRI */}
            <div className="flex flex-col lg:w-[535px] md:w-[400px] w-[250px] lg:h-[296px]">
              <h2 className="text-[#092079] text-3xl montserrat font-[700] text-left text-[36px] pb-6">
                ABOUT SPEAKER,
              </h2>
              <p className="text-[#092079] text-justify">
            ...
            {/* KARTU SPEAKER */}
            <div
              className="flex flex-col lg:w-[325px] lg:h-[450px] rounded-xl shadow-[0_4px_4px_0_rgba(0,0,0,0.25)]"
              style={{
                background: "linear-gradient(317deg, #092079 0%, #4F9BFD 100%)",
              }}
            >
              <Image
                src="/"
                ...
                width={500}
                height={500}
                className="lg:w-[350px] lg:h-[350px] w-[205px] h-[205px]"
              />
              <h2 className="text-white lg:text-[24px] tracking-[-0.48px] font-[700] montserrat py-5 items-center">
                SPEAKER NAME
              </h2>
            </div>
          </div>
          <div className="flex flex-col-reverse items-center justify-center tmd:flex-row flex-shrink-0 gap-10 snap-always snap-center">
            {/* TULISAN-KIRI */}
            <div className="flex flex-col lg:w-[535px] md:w-[400px] w-[250px] lg:h-[296px]">
              <h2 className="text-[#092079] text-3xl montserrat font-[700] text-left text-[36px] pb-6">
                ABOUT SPEAKER,
      ...
      <Image
        ...
        width={572}
        height={572}
        className="w-[500px] aspect-square absolute z-10 bottom-[700px] left-[-80px]"
      ></Image>
        ...
        <div class="w-fit max-w-[80%] flex justify-center flex-wrap">
          ...
          <div class="flex flex-col gap-[60px] mx-auto max-w-[100%]">
            <h1 class=" md:w-4/6 break-words text-left font-montserrat text-white font-bold text-[24px] md:text-[36px]">
              Mengapa <span class="text-custom-yellow">Harus Join Byte</span>{" "}
              Summit?
            </h1>
