  ...
  return (
    <main className="bg-[#092079] min-h-screen overflow-hidden overflow-x-hidden relative flex flex-col">
      ...
      <div className="lg:mx-20 mx-10 pt-20 ">
        ...
        <p className= "py-10 px-3 tracking-[0.16px] text-[16px] text-white max-w-[1000px] font-[4vw] mx-auto text-center">Ultricies mi quis hendrerit dolor. A pellentesque sit amet porttitor eget dolor morbi. Nisl purus in mollis nunc sed id semper risus. Semper quis lectus nulla at. Lorem ipsum dolor sit amet consectetur adipiscing. Dui id ornare arcu odio ut. Fusce id velit ut tortor pretium viverra suspendisse.</p>
      </div>

      {/* ABOUT SPEAKER MODIFIED */}
      <div className="flex items-center justify-center mx-auto rounded-[10px] max-w-[1200px] shadow xl: shadow-white/20 lg:h-[681px] lg:w-[1100px] md:w-[750px] lg:mx-auto" style={{"background": "linear-gradient(146deg, rgba(255, 255, 255, 0.60) 0%, rgba(255, 255, 255, 0.20) 100%)"}}>
        {/* CONTAINER PUTIH */}
        <div className="flex lg:flex-row m-5 gap-20 py-20 px-7 lg:px-20 bg-white w-[300px] md:w-[1050px] overflow-x-visible snap-both sm:h-[1250px] md:h-[600px] lg:h-[615px] rounded-lg overflow-y-hidden text-center snap-mandatory">
            ...
            <div className="flex flex-col-reverse sm:flex-row items-center justify-center lg:flex-row flex-shrink-0 gap-10 snap-always snap-center">
                ...
                {/* KARTU SPEAKER */}
                <div className="flex flex-col lg:w-[325px] lg:h-[450px] rounded-xl shadow-[0_4px_4px_0_rgba(0,0,0,0.25)]"  style={{"background": "linear-gradient(317deg, #092079 0%, #4F9BFD 100%)"}}>
                    <Image src="/tes-thea.jpg" alt="Speaker" width={500} height={500} className= "lg:w-[350px] lg:h-[350px] w-[205px] h-[205px]"/>
